...
func (b *Bot) showAudienceSelection(bot *telego.Bot, chatID int64, broadcastID int, lang string) {
	...
	kb := tu.InlineKeyboard(
		...
		tu.InlineKeyboardRow(tu.InlineKeyboardButton(locale.Get("broadcast.audience_kk", lang, nil)).WithCallbackData(fmt.Sprintf("broadcast|audience|%d|kk", broadcastID))),
